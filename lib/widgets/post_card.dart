...
import 'package:instagram_clone/screens/feed%20screen/comments_screen.dart';
...
class _PostCardState extends State<PostCard> {
  ...
  void initState() {
    ...
    isSaved = user?.saved.contains(widget.snap['postId']) ?? false;
  }
                  ...
                  child: Container(
                    ...
                    child: Text(
                      formatTimestamp(
                        ...
                        isComment: false, // Use the long/date format
                      ),
